...
static PurplePluginProtocolInfo prpl_info = {
    ...
    .options = OPT_PROTO_IM_IMAGE | OPT_PROTO_NO_PASSWORD, // with OPT_PROTO_NO_PASSWORD set, Pidgin will neither ask for a password and also won't store it. Yet storing a password is necessary for compatibility with bitlbee. See login.c for more information.
