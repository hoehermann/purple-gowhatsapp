...
CHARCONSTANT(GOWHATSAPP_ATTACHMENT_DIRECTORY_OPTION, "attachment-directory");
CHARCONSTANT(GOWHATSAPP_ATTACHMENT_DIRECTORY_DEFAULT, "");
CHARCONSTANT(GOWHATSAPP_ATTACHMENT_BASE_URL_OPTION, "attachment-base-url");
CHARCONSTANT(GOWHATSAPP_ATTACHMENT_BASE_URL_DEFAULT, "");
