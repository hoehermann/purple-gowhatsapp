...
CHARCONSTANT(GOWHATSAPP_DATABASE_ADDRESS_DEFAULT, "file:$purple_user_dir/whatsmeow.db?_pragma=foreign_keys(1)");
 ...
 */
CHARCONSTANT(GOWHATSAPP_IMAGES_CHOICE_INLINE, "inline");
CHARCONSTANT(GOWHATSAPP_IMAGES_CHOICE_XFER, "xfer");
CHARCONSTANT(GOWHATSAPP_IMAGES_CHOICE_BOTH, "both");
